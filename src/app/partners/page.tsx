    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20">
      ...
      <section className="relative pt-32 pb-24 px-4">
        <div className="container mx-auto max-w-4xl">
          <h1 className="text-6xl font-black mb-6 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Partners</h1>
          <p className="text-2xl text-slate-600 dark:text-slate-400">Partnership opportunities coming soon</p>
        </div>
      </section>
    </div>
  );
